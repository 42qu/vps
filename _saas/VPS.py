...
class Client(Iface):
  ...
  def sms(self, number_list, txt):
    ...
    Parameters:
     ...
     - txt
    """
    self.send_sms(number_list, txt)
    return self.recv_sms()

  def send_sms(self, number_list, txt):
    self._oprot.writeMessageBegin('sms', TMessageType.CALL, self._seqid)
    args = sms_args()
  ...
  def host_list(self, ):
    self.send_host_list()
    return self.recv_host_list()

  def send_host_list(self, ):
    self._oprot.writeMessageBegin('host_list', TMessageType.CALL, self._seqid)
    args = host_list_args()
    args.write(self._oprot)
    self._oprot.writeMessageEnd()
    self._oprot.trans.flush()

  def recv_host_list(self, ):
    (fname, mtype, rseqid) = self._iprot.readMessageBegin()
    if mtype == TMessageType.EXCEPTION:
      x = TApplicationException()
      x.read(self._iprot)
      self._iprot.readMessageEnd()
      raise x
    result = host_list_result()
    result.read(self._iprot)
    self._iprot.readMessageEnd()
    if result.success is not None:
      return result.success
    raise TApplicationException(TApplicationException.MISSING_RESULT, "host_list failed: unknown result");
  ...
  def migrate_task(self, vps_id):
    ...
    Parameters:
     - vps_id
    """
    self.send_migrate_task(vps_id)
    return self.recv_migrate_task()

  def send_migrate_task(self, vps_id):
    self._oprot.writeMessageBegin('migrate_task', TMessageType.CALL, self._seqid)
    args = migrate_task_args()
    args.vps_id = vps_id
    args.write(self._oprot)
    self._oprot.writeMessageEnd()
    self._oprot.trans.flush()

  def recv_migrate_task(self, ):
    (fname, mtype, rseqid) = self._iprot.readMessageBegin()
    if mtype == TMessageType.EXCEPTION:
      x = TApplicationException()
      x.read(self._iprot)
      self._iprot.readMessageEnd()
      raise x
    result = migrate_task_result()
    result.read(self._iprot)
    self._iprot.readMessageEnd()
    if result.success is not None:
      return result.success
    raise TApplicationException(TApplicationException.MISSING_RESULT, "migrate_task failed: unknown result");
...
class Processor(Iface, TProcessor):
  def __init__(self, handler):
    ...
    self._processMap["host_refresh"] = Processor.process_host_refresh
    self._processMap["host_list"] = Processor.process_host_list
    self._processMap["migrate_task"] = Processor.process_migrate_task
  ...
  def process_sms(self, seqid, iprot, oprot):
    args = sms_args()
    args.read(iprot)
    iprot.readMessageEnd()
    result = sms_result()
    result.success = self._handler.sms(args.number_list, args.txt)
    oprot.writeMessageBegin("sms", TMessageType.REPLY, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()

  def process_host_refresh(self, seqid, iprot, oprot):
    args = host_refresh_args()
    args.read(iprot)
    iprot.readMessageEnd()
    result = host_refresh_result()
  ...
  def process_host_list(self, seqid, iprot, oprot):
    args = host_list_args()
    args.read(iprot)
    iprot.readMessageEnd()
    result = host_list_result()
    result.success = self._handler.host_list()
    oprot.writeMessageBegin("host_list", TMessageType.REPLY, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()

  def process_migrate_task(self, seqid, iprot, oprot):
    args = migrate_task_args()
    args.read(iprot)
    iprot.readMessageEnd()
    result = migrate_task_result()
    result.success = self._handler.migrate_task(args.vps_id)
    oprot.writeMessageBegin("migrate_task", TMessageType.REPLY, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()
...
class sms_args:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.LIST, 'number_list', (TType.STRING,None), None, ), # 1
    (2, TType.STRING, 'txt', None, None, ), # 2
  )

  def __init__(self, number_list=None, txt=None,):
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('sms_args')
    ...
    if self.txt is not None:
      oprot.writeFieldBegin('txt', TType.STRING, 2)
...
class sms_result:
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('sms_result')
    if self.success is not None:
...
class host_refresh_args:
  ...
  thrift_spec = (
    ...
    (4, TType.I16, 'hd_total', None, 0, ), # 4
    (5, TType.I64, 'ram_total', None, 0, ), # 5
  )

  def __init__(self, host_id=None, hd_remain=None, ram_remain=None, hd_total=thrift_spec[4][4], ram_total=thrift_spec[5][4],):
    self.host_id = host_id
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('host_refresh_args')
    if self.host_id is not None:
      oprot.writeFieldBegin('host_id', TType.I64, 1)
      oprot.writeI64(self.host_id)
      oprot.writeFieldEnd()
    if self.hd_remain is not None:
      oprot.writeFieldBegin('hd_remain', TType.I16, 2)
      oprot.writeI16(self.hd_remain)
      oprot.writeFieldEnd()
    ...
    if self.hd_total is not None:
      oprot.writeFieldBegin('hd_total', TType.I16, 4)
      oprot.writeI16(self.hd_total)
      oprot.writeFieldEnd()
...
class host_refresh_result:
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('host_refresh_result')
    oprot.writeFieldStop()
    oprot.writeStructEnd()
...
class host_list_args:
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('host_list_args')
    oprot.writeFieldStop()
    oprot.writeStructEnd()
...
class host_list_result:
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('host_list_result')
    if self.success is not None:
...
class migrate_task_args:
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('migrate_task_args')
    if self.vps_id is not None:
      oprot.writeFieldBegin('vps_id', TType.I64, 1)
      oprot.writeI64(self.vps_id)
      oprot.writeFieldEnd()
...
class migrate_task_result:
  ...
  thrift_spec = (
    (0, TType.STRUCT, 'success', (MigrateTask, MigrateTask.thrift_spec), None, ), # 0
  )
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('migrate_task_result')
    if self.success is not None:
      oprot.writeFieldBegin('success', TType.STRUCT, 0)
      self.success.write(oprot)
      oprot.writeFieldEnd()
