...
if __name__ == "__main__":
    ...
    assert check_gateway_ipv4(ip2int('10.10.10.2'), ip2int('255.255.255.0'), ip2int('10.10.10.1'))
    assert not check_gateway_ipv4(ip2int('10.10.10.2'), ip2int('255.255.255.0'), ip2int('10.10.2.1'))
    assert check_gateway_ipv4(ip2int('119.254.32.162'), ip2int('255.255.255.240'), ip2int('119.254.32.161'))
